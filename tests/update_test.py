...
def test_update_entityview():
    ...
    view_df = synAnnotationUtils.update.dropIndex('index', view_df)
    ...
    synAnnotationUtils.update.updateEntityView(syn=syn, syn_id=view_id, path=file_name, index_col='index', clause=None)
    ...
    updated_df = synAnnotationUtils.update.dropIndex(index_col='index', view_df=updated_df)
